...
//自适应阈值操作
public class AdaptiveThresholdFragment extends PageFragment {
    ...
    public Bitmap option(Bitmap src){
        ...
        //这一步是将CV_8UC4转成CV8UC1
        Mat tmpMat = new Mat();
        Imgproc.cvtColor(srcMat,tmpMat,Imgproc.COLOR_RGBA2GRAY);
        ...
        Imgproc.adaptiveThreshold(tmpMat, dstMat, 120, Imgproc.ADAPTIVE_THRESH_GAUSSIAN_C, Imgproc.THRESH_BINARY, 5,  5);
